...
public class login extends javax.swing.JFrame {
    ...
    public login() {
        initComponents();
        txtCorreo.setBackground(new Color(54,33,89));
        txtContraseña.setBackground(new Color(54,33,89));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/LOGOGYM.jpg"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 480, 340));
        ...
        txtContraseña.setSelectedTextColor(new java.awt.Color(204, 204, 204));
        txtContraseña.setSelectionColor(new java.awt.Color(122, 72, 221));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        // Llamar al método para validar el usuario
        Metodos metodos = new Metodos();
        metodos.validarUsuario(correo, contraseña,this);
        limpiarCampos();
